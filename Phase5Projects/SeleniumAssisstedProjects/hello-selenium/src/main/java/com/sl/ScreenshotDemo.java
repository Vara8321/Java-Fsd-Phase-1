...
public class ScreenshotDemo {
	...
	public static void main(String[] args) throws InterruptedException, IOException {
		...
		File destinationFile = new File("C:\\Users\\chitt\\eclipse-enterprise\\hello-selenium\\SS1.jpg");
		...
		destinationFile = new File("C:\\Users\\chitt\\eclipse-enterprise\\hello-selenium\\SS2.jpg");
		Files.copy(imgTmpFile, destinationFile);
