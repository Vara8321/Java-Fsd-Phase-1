...
public class AdvancedLocatingElements {
	...
	static void demoExternalElementsNewTab() throws InterruptedException {
		driver.get("file:///C:/Users/chitt/eclipse-enterprise/hello-selenium/src/main/resources/test.html");
	...
	static void demoExternalElementsAlerts() throws InterruptedException {
		//String baseUrl = "https://github.com/aw1app/sl-dec23/blob/main/PHASE5/hello-selenium/src/main/resources/test.html";
		 String baseUrl =
		 "file:///C:/Users/chitt/eclipse-enterprise/hello-selenium/src/main/resources/test.html";
		driver.get(baseUrl);
	...
	static void demoDropDownList() {
		...
		String baseUrl = "file:///C:/Users/chitt/eclipse-enterprise/hello-selenium/src/main/resources/test.html";
		driver.get(baseUrl);
	...
	public static void locateMobileTF() {
		...
		//WebElement mobileNoTF = driver.findElement(By.xpath("input[3]"));
